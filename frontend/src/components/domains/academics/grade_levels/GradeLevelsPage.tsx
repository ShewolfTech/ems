...
import { GradeLevelsList } from "./GradeLevelsList.js";
import { GradeLevelsForm } from "./GradeLevelsForm.js";
...
export function GradeLevelsPage() {
  ...
  const { data, loading, reload, save, update, remove } = useGradeLevels({ autoFetch: true }) as any;
        ...
        <div>
          <div className="p-6">
            <div className="flex justify-between items-center mb-6">
              <div>
                <h1 className="text-2xl font-bold text-gray-800">Grade Levels</h1>
                <p className="text-gray-600">Manage all grade level records</p>
              </div>
              <button
          ...
          <GradeLevelsList data={filteredData} loading={loading} onSelect={handleView} onDelete={handleDelete} />
        </div>
      ) : (
        <div className="p-6">
          <GradeLevelsForm
