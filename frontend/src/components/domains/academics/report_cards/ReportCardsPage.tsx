...
import { useReportCards } from "@/domains/academics/report_cards/hooks/useReportCards.js";
import { ReportCardsList } from "./ReportCardsList.js";
import { ReportCardsForm } from "./ReportCardsForm.js";
...
export function ReportCardsPage() {
  ...
  const { data, loading, reload, save, update, remove } = useReportCards({ autoFetch: true }) as any;
    ...
    <div className="min-h-screen bg-gray-100">
      {view === 'list' ? (
        <div>
          <div className="p-6">
            <div className="flex justify-between items-center mb-6">
              <div>
                ...
                <p className="text-gray-600">Manage all report card records</p>
              </div>
              <button
          ...
          <ReportCardsList data={filteredData} loading={loading} onSelect={handleView} onDelete={handleDelete} />
        </div>
      ) : (
        <div className="p-6">
          <ReportCardsForm
