...
import { useExamResults } from "@/domains/academics/exam_results/hooks/useExamResults.js";
import { ExamResultsList } from "./ExamResultsList.js";
import { ExamResultsForm } from "./ExamResultsForm.js";
...
export function ExamResultsPage() {
  ...
  const { data, loading, reload, save, update, remove } = useExamResults({ autoFetch: true }) as any;
    ...
    <div className="min-h-screen bg-gray-100">
      {view === 'list' ? (
        <div>
          <div className="p-6">
            <div className="flex justify-between items-center mb-6">
              <div>
                ...
                <p className="text-gray-600">Manage all exam result records</p>
              </div>
              <button
          ...
          <ExamResultsList data={filteredData} loading={loading} onSelect={handleView} onDelete={handleDelete} />
        </div>
      ) : (
        <div className="p-6">
          <ExamResultsForm
