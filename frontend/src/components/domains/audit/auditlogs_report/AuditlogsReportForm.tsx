...
export function AuditlogsReportForm({ initialData, onClose, onSave }: any) {
  ...
  return (
    <div className="bg-white rounded-[3rem] shadow-2xl border border-slate-200 overflow-hidden">
      <div className="p-8 border-b flex justify-between items-center bg-slate-50">
        <h3 className="font-black text-2xl text-slate-900">AuditlogsReport Editor</h3>
      ...
      <form onSubmit={handleSubmit} className="p-10 space-y-6">
        <div className="grid grid-cols-2 gap-6">
          ...
          <Input label="New Value" name="new_value" defaultValue={initialData?.["new_value"]} />
          <Input label="Old Value" name="old_value" defaultValue={initialData?.["old_value"]} />
          ...
          <Input label="School Scope" name="school_scope" defaultValue={initialData?.["school_scope"]} />
...
export default AuditlogsReportForm;