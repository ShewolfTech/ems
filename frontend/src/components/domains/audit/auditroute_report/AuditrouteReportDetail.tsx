...
interface AuditrouteReportDetailProps {
  item: any;
  onClose: () => void;
}

export function AuditrouteReportDetail({ item, onClose }: AuditrouteReportDetailProps) {
  return (
    <div className="bg-white rounded-[3rem] shadow-2xl border border-slate-200 overflow-hidden">
      <div className="p-8 border-b flex justify-between items-center bg-slate-50">
        <h3 className="font-black text-2xl text-slate-900">AuditrouteReport Details</h3>
      ...
      <div className="p-10 space-y-6">
        ...
        <div className="flex flex-col">
          <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Audit Id</span>
          <span className="text-lg font-bold text-slate-900">{String(item.audit_id ?? "—")}</span>
        </div>
        <div className="flex flex-col">
          <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Diff</span>
          <span className="text-lg font-bold text-slate-900">{String(item.diff ?? "—")}</span>
        </div>
        <div className="flex flex-col">
        ...
        <div className="flex flex-col">
          <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Permission Resource</span>
          <span className="text-lg font-bold text-slate-900">{String(item.permission_resource ?? "—")}</span>
        </div>
        <div className="flex flex-col">
...
export default AuditrouteReportDetail;