...
interface ReportAttendanceComplianceListProps {
  data?: any[];
  loading?: boolean;
...
export function ReportAttendanceComplianceList({ data, loading, onSelect, pageSize = PAGE_SIZE }: ReportAttendanceComplianceListProps) {
...
export default ReportAttendanceComplianceList;