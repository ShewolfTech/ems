...
export function CampusAccessLogsForm({ initialData, onClose, onSave }: any) {
  ...
  return (
    <div className="bg-white rounded-[3rem] shadow-2xl border border-slate-200 overflow-hidden">
      <div className="p-8 border-b flex justify-between items-center bg-slate-50">
        <h3 className="font-black text-2xl text-slate-900">CampusAccessLogs Editor</h3>
      ...
      <form onSubmit={handleSubmit} className="p-10 space-y-6">
        <div className="grid grid-cols-2 gap-6">
          ...
          <Input label="Event At" name="event_at" type="date" defaultValue={initialData?.["event_at"]?.split('T')[0]} />
          <Input label="Event Type" name="event_type" defaultValue={initialData?.["event_type"]} />
          ...
          <Input label="Location Name" name="location_name" defaultValue={initialData?.["location_name"]} />
...
export default CampusAccessLogsForm;