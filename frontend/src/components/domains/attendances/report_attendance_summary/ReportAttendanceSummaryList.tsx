...
interface ReportAttendanceSummaryListProps {
  data?: any[];
  loading?: boolean;
...
export function ReportAttendanceSummaryList({ data, loading, onSelect, pageSize = PAGE_SIZE }: ReportAttendanceSummaryListProps) {
...
export default ReportAttendanceSummaryList;