...
interface ReportLeaveSummaryListProps {
  data?: any[];
  loading?: boolean;
...
export function ReportLeaveSummaryList({ data, loading, onSelect, pageSize = PAGE_SIZE }: ReportLeaveSummaryListProps) {
...
export default ReportLeaveSummaryList;