...
interface StaffmgtTeacherWorkloadViewListProps {
  data?: any[];
  loading?: boolean;
...
export function StaffmgtTeacherWorkloadViewList({ data, loading, onSelect, pageSize = PAGE_SIZE }: StaffmgtTeacherWorkloadViewListProps) {
...
export default StaffmgtTeacherWorkloadViewList;