...
interface StaffmgtTeachereffectivenessViewListProps {
  data?: any[];
  loading?: boolean;
...
export function StaffmgtTeachereffectivenessViewList({ data, loading, onSelect, pageSize = PAGE_SIZE }: StaffmgtTeachereffectivenessViewListProps) {
...
export default StaffmgtTeachereffectivenessViewList;