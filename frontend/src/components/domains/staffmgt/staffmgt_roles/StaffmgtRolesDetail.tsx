...
interface StaffmgtRolesDetailProps {
  item: any;
  onClose: () => void;
}

export function StaffmgtRolesDetail({ item, onClose }: StaffmgtRolesDetailProps) {
  return (
    <div className="bg-white rounded-[3rem] shadow-2xl border border-slate-200 overflow-hidden">
      <div className="p-8 border-b flex justify-between items-center bg-slate-50">
        <h3 className="font-black text-2xl text-slate-900">StaffmgtRoles Details</h3>
...
export default StaffmgtRolesDetail;