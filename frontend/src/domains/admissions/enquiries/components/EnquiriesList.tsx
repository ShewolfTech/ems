...
import type { Enquiry, EnquiryStatistics, EnquiryType, EnquirySource } from '../types.js';
                ...
                {enquiries.map((enquiry) => (
                  <tr key={enquiry.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      {enquiry.enquiry_type_name && (
                        <span 
                          ...
                          style={{ 
                            backgroundColor: `${enquiry.enquiry_type_color}20`,
                            color: enquiry.enquiry_type_color 
                          }}
                        >
                          {enquiry.enquiry_type_name}
                        </span>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      ...
                      <button className="text-red-600 hover:text-red-900" onClick={() => handleDelete(enquiry.id!)}>
                        Delete
                      </button>
                    </td>
                  </tr>
